...
class UrlFragment implements UrlComponentInterface
{
	...
	/**
	 *
	 * @param string|UrlFragment|NULL $value
	 * @throws \InvalidArgumentException
	 */
	public function set($value)
	{
		if ($value instanceof UrlFragment) {
			$this->str = $value->str;
	...
	/**
	 * @param UrlFragment|string|NULL $other
	 *
	 * {@inheritDoc}
	...
	{
		return is_null($this->str) ? '' : rawurlencode($this->str);
	}
